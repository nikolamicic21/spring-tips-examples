...
@DataR2dbcTest
internal class SpringDataR2DbcReservationRepositoryTest {

    @Autowired
    private lateinit var reservationRepository: SpringDataR2DbcReservationRepository

    @TestConfiguration
    class SpringDataR2DbcReservationRepositoryTestConfig {
